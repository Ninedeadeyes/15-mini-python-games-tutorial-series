...
larder=[]
goal=["Fish Bone Spear","Small Hut"]
...
class Goblin(object):
    ...
    def status(self):
        ...
        print("I have",self.provision,"provisions")
        print("I have",inventory,"in your bag" )
        print("I have",self.gold, "gold")
        print("I am ",self.hung)
        print("I am ",self.wounded)
        self.__pass_time()
    ...
    def hunt(self):
        ...
        print ("The Goblin came across a",enemy)
        print("After an epic fight The Goblin took ",damage,"damage")         
...
def main():
    ...
    gob_name = input("What do you want to name your Grot?: ")
