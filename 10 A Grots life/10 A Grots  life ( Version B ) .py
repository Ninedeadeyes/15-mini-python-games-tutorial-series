...
class Game:
    ...
    def play(self):
        choice = None  
        while choice != "0":
            print(f" So... {self.gob_name} What is your action ?")
            print("""
            0 - Quit
            1 - Status
            2 - Eat
            ...
            if not self.endgame and all(goal in self.gob.goal for goal in ["Fish Bone Spear","Straw Bed","Small Hut"]):
