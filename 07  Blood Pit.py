...
#Fight a selection of monsters in the blood pit to gain reputation and glory. 
#Demonstrate how to use 'F string' and a user defined function with multiple arguments.
