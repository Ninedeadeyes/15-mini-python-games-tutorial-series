# The Slumber of the Doom King

# Break into the Doom King's castle and steal as much gold as possible and find an escape before the king 
# consumes your soul. Using DICTIONARY,NESTED DICTIONARY and RETURN function.
