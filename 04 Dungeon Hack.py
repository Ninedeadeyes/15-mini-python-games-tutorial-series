...
#An adventure simulation game. You need to pick a band of adventurers and complete a dungeon run.
#Depending on the combination of adventurers it will dictate the outcome of the dungeon run. Using FOR LOOP.
