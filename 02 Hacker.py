...
#Goal of the game is to hack into Robert's account. The more attempts, the more clues it provide. 
#Implement the use of INPUT function, VARIABLES, WHILE loop, BREAK statement and IF ELSE STATEMENTS.
